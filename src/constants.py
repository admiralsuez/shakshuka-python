...
DEBUG_MODE: Final[bool] = os.getenv("SHAKSHUKA_DEBUG", "true").lower() in {
    "1",
    "true",
    "yes",
}
AUTH_ENABLED: Final[bool] = os.getenv("SHAKSHUKA_AUTH_ENABLED", "false").lower() in {
    "1",
    "true",
    "yes",
}
...
DB_POOL_WAIT_TIMEOUT: Final[float] = float(
    os.getenv("SHAKSHUKA_DB_POOL_WAIT_TIMEOUT", "5")
)
